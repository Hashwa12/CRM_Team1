...
public class PurchaseOrder extends JFrame {
	...
	public PurchaseOrder() {
		...
		lblCustomerRelationshipManagement.setBounds(181, 11, 393, 20);
		contentPane.add(lblCustomerRelationshipManagement);
		
		JButton btnHome = new JButton("Home");
		btnHome.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		...
		btnCampaign.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		btnCampaign.setBounds(88, 53, 80, 25);
		contentPane.add(btnCampaign);
		
		JButton btnLead = new JButton("Lead");
		btnLead.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		...
		btnSaleOrder.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		...
		btnProduct.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		btnProduct.setBounds(479, 53, 80, 25);
		contentPane.add(btnProduct);
		
		JButton btnPurchesOrder = new JButton("Purches Order");
		btnPurchesOrder.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		...
		btnLogout.setBounds(703, 53, 101, 25);
		...
		btnCancle.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		btnCancle.setBounds(394, 393, 89, 23);
		contentPane.add(btnCancle);
		
		JLabel lblCompanyName = new JLabel("Company Name");
		lblCompanyName.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		lblCompanyName.setBounds(164, 113, 110, 14);
		contentPane.add(lblCompanyName);
		
		JLabel lblVendorName = new JLabel("Vendor Name");
		lblVendorName.setFont(new Font("Times New Roman", Font.PLAIN, 14));
